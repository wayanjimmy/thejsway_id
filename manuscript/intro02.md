...
* **Komputer** adalah mesin yang bertugas menjalankan perintah-perintah yang diinstruksikan kepadanya dengan cepat.

* **Program** adalah senarai dari perintah yang diberikan ke sebuah komputer. Perintah ini berbentuk perintah teks. Semua perintah yang diinstruksikan akan membentuk **kode sumber** dari sebuah program.
